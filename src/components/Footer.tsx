...
export function Footer() {
  return (
    <footer className="mt-10 px-(--gutter) pb-(--gutter)">
      <div className="glass mx-auto w-full max-w-6xl rounded-4xl px-(--gutter) py-14 sm:px-10">
        ...
        <div className="mt-12 flex flex-col gap-2 border-t border-white/8 pt-6 text-xs text-faint sm:flex-row sm:items-center sm:justify-between">
          <p>
